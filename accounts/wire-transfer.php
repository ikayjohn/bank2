                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <label for="basic-url">Routing Number or SWIFT</label>
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" required placeholder="Routing Number or SWIFT" name="routine_number" aria-label="Username">
                                </div>
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" name="wire-transfer">Proceed</button>
                                </div>
