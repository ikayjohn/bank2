    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="/">
                    <img src="<?= $web_url ?>/assets/images/logo/logo.png" class="navbar-logo" alt="logo">
                </a>
            </li>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="submenu list-unstyled collapse" id="starter-kit7" data-parent="#accordionExample" style="">
                        ...
                        <li>
                            <a href="./check-deposit.php"> Cheque Deposit </a>
                        </li>
                    ...
                    <ul class="collapse submenu list-unstyled" id="submenu2" data-parent="#accordionExample">
                        ...
                        <li>
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="sm2" data-parent="#submenu2">
                                ...
                                <li>
                                    <a href="./settings-pin.php">Secure PIN </a>
                                </li>
                                <li>
