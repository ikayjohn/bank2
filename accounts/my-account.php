                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                    <div class="upload mt-4 pr-md-4">
                                                        ...
                                                        <button class="mt-2" type="submit" name="upload_picture"><i class="flaticon-cloud-upload mr-1"></i> Upload Photo</button>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p><strong><?= $row['acct_email'] ?></strong></p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p><strong><?= $row['internetid'] ?></strong></p>
                                                                </div>
                                                            </div>
