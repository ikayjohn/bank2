...
if (isset($_POST['wire_submit'])) {
    ...
    if ($pin !== $oldPin) {
        toast_alert('error', 'Incorrect PIN');
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Kindly validate this transaction with your account PIN!</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <label for="basic-url">Secure PIN</label>
                                ...
                                <div class="input-group">
                                    <button class="btn btn-primary mb-2" type="submit" name="wire_submit">Verify PIN</button>
                                </div>
