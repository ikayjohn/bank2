                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-4">
                                    <textarea class="form-control" aria-label="With textarea" rows="6" required name="description" placeholder="Please describe the issue you're experiencing. Include any relevant details such as error messages, affected services, and steps to reproduce the problem."></textarea>
                                </div>
